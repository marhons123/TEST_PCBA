...
#define NORFLASH_SECTOR_SIZE    4096   // 每个扇区 4KB
#define NORFLASH_SECTOR_COUNT   8192   // 32MB / 4KB = 8192 个扇区
#define NORFLASH_BLOCK_SIZE     16  // 每个块 64KB（16个扇区）,以扇区为单位
...
void norflash_write(const uint8_t *pbuf, uint32_t addr, uint16_t datalen);    /* 写入flash */
